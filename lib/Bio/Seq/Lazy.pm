package Bio::Seq::Lazy;

use strict;
use warnings;

# use this for now, until we get streams working
use base qw(Bio::Seq);
...
Bio::Seq::Lazy - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Bio::Seq::Lazy version .
