...
Bio::Stream::Annotation - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Bio::Stream::Annotation version .

=head1 SYNOPSIS

   use Bio::Stream::Annotation;
