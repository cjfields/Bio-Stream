...
Bio::Stream::Collection - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to Bio::Stream::Collection version Biome.

=head1 SYNOPSIS

   use Bio::Stream::Collection;
